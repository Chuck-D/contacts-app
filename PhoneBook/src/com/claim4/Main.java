...
import com.claim4.Contacts;

//not allowed to use an ArrayList in this assignment
...
public class Main {
	...
	public static void main(String[] args) {
        ...
        //flag true for it being the first record        
        boolean flag = true;
     
        //a do/while loop to keep the program running until option 11 is selected.
        ...
        do {        	
            ...
            switch(userSelection) {
            	case 1:	System.out.println("Please enter your contact's info in the following format: ");
            			...
            			//converting user input to a string array to make it easier to work with
            			String[] contactRecord2Array = new String[6];
            			contactRecord2Array = contactRecord.split(",");            			
            			
            			//isolating the needed elements in the  full name.
            	...
            	//		String phoneNumber = contactRecord2Array[5];
            			...
            			//setting the flag to false to signal the first entry has already been input
            		flag = false;
            	...
            	case 4:	System.out.println("Enter the contacts full name.  Please use the following format: ");
                    	...
                    	//split the input at the space to use in an array to access individual elements.
